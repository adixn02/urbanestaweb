    ...
    <div className="min-h-screen bg-white">
          ...
          <div className="row justify-content-center">
            <div className="col-12 col-lg-10 text-center">
              <h1 className="display-3 display-md-1 fw-bold text-dark mb-4">
                About <span className="text-primary">Urbanesta</span>
              </h1>
          ...
          <div className="row g-4 justify-content-center">
            ...
            <div className="col-12 col-lg-6">
              <div className="text-center text-lg-start">
                <div className="d-inline-flex align-items-center justify-content-center bg-primary bg-opacity-10 rounded-3 mb-4" style={{width: '80px', height: '80px'}}>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="text-center mb-5">
            <div className="d-inline-flex align-items-center justify-content-center bg-primary rounded-3 mb-4" style={{width: '80px', height: '80px'}}>
              ...
              <div className="card h-100 border-0 shadow-sm hover-shadow transition-all">
                <div className="card-body p-4">
                  <div className="position-relative mb-4">
                    <div className="bg-primary bg-gradient rounded-2 d-flex align-items-center justify-content-center mb-3" style={{width: '80px', height: '80px'}}>
                ...
                <div className="card-body p-4">
                  <div className="position-relative mb-4">
                    <div className="bg-success bg-gradient rounded-2 d-flex align-items-center justify-content-center mb-3" style={{width: '80px', height: '80px'}}>
                      <i className="bi bi-shield-check-fill text-white fs-3"></i>
                    </div>
                  </div>
      ...
      <section className="py-5 bg-white">
        <div className="container">
          ...
          {/* Section Header */}
          <div className="text-center mb-5">
            <div className="d-inline-flex align-items-center justify-content-center bg-primary bg-gradient rounded-3 mb-4" style={{width: '80px', height: '80px'}}>
              <i className="bi bi-heart-fill text-white fs-3"></i>
            </div>
            <h2 className="display-3 fw-bold text-dark mb-4">
              Why Choose <span className="text-primary">Urbanesta</span>?
            </h2>
              ...
              <div className="card-body p-4 p-md-5">
                <div className="row align-items-center g-4">
                  <div className="col-12 col-md-auto text-center">
                    <div className="bg-primary rounded-3 d-flex align-items-center justify-content-center mx-auto" style={{width: '120px', height: '120px'}}>
                      <span className="display-4 fw-bold text-white">AM</span>
                    </div>
                  </div>
                  <div className="col-12 col-md text-center text-md-start">
                    <h3 className="h1 fw-bold text-dark mb-1">Anil Maan</h3>
                    <p className="text-primary fw-bold fs-5 mb-3">Founder & CEO</p>
                    <blockquote className="fs-5 text-muted fst-italic">
          ...
          <div className="row g-3 mb-5">
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <div className="card text-center border-0 shadow-sm h-100 bg-primary bg-opacity-10">
                <div className="card-body p-3">
                  <div className="bg-primary rounded-2 d-flex align-items-center justify-content-center mx-auto mb-3" style={{width: '60px', height: '60px'}}>
                    <i className="bi bi-house-fill text-white fs-4"></i>
                  </div>
                  <h3 className="h2 fw-bold text-primary mb-2">1,600+</h3>
                  <p className="small fw-semibold text-muted">Residential Projects</p>
                </div>
              </div>
            </div>
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <div className="card text-center border-0 shadow-sm h-100 bg-purple bg-opacity-10">
                <div className="card-body p-3">
                  ...
                  <h3 className="h2 fw-bold text-purple mb-2">90+</h3>
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <div className="card text-center border-0 shadow-sm h-100 bg-warning bg-opacity-10">
                <div className="card-body p-3">
                  ...
                  <h3 className="h2 fw-bold text-warning mb-2">1,000+</h3>
          ...
          <div className="row g-4 justify-content-center">
            <div className="col-12 col-md-6 col-lg-4">
              <div className="card text-center border-0 shadow-sm h-100">
                <div className="card-body p-4">
                  <div className="bg-primary bg-opacity-10 rounded-2 d-flex align-items-center justify-content-center mx-auto mb-3" style={{width: '60px', height: '60px'}}>
              ...
              <div className="card text-center border-0 shadow-sm h-100">
                <div className="card-body p-4">
                  <div className="bg-purple bg-opacity-10 rounded-2 d-flex align-items-center justify-content-center mx-auto mb-3" style={{width: '60px', height: '60px'}}>
                    <i className="bi bi-person-heart text-purple fs-4"></i>
                  </div>
